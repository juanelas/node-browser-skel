...
const templatePath = path.join(rootDir, pkgJson.directories.templates, 'tests-template.html')
const dstDir = path.join(rootDir, pkgJson.directories.test, 'browser')
const dstFileName = path.join(dstDir, 'index.html')

const template = fs.readFileSync(templatePath, 'utf-8')
const bundleFile = path.join(rootDir, pkgJson.directories.dist, 'index.browser.bundle.mod.js')
const testsJs = `
  <script type="module">
